...
+ Block: Redstone Inverter
+ Block: Redstone Delay
+ Block: Redstone Pulse
+ Block: Redstone Oscillator
+ Block: Redstone Regulator
+ Block: Redstone Resistor
+ Block: Redstone Coil
+ Block: Redstone Signal Operator
+ Block: Redstone Logic Operator
+ Block: Manlight Detector
+ Block: Light Detector
+ Recipes for all new blocks
+ EN_US localization
+ In-game UI for basic Redstone contraption debugging